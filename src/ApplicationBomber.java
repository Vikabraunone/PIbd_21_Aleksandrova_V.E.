	...
	private void initialize() {
		...
		buttonCreate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				CountBomb[] colors = CountBomb.values();
				bomber = new Bomber(100 + rnd.nextInt(200), 100 + rnd.nextInt(200), new Color(0, 128, 0), Color.BLACK, true, true, true, colors[rnd.nextInt(colors.length)]);
