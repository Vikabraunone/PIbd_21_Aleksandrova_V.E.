...
public class ApplicationBomber {
	...
	private void initialize() {
		...
		panelWarPlane.setBounds(0, 0, 858, 450);
		frameBomber.getContentPane().add(panelWarPlane);
		...
		buttonCreateWarPlane.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				warPlane.SetPosition(rnd.nextInt(90) + 10, rnd.nextInt(90) + 10, panelWarPlane.getWidth(),
						panelWarPlane.getHeight());
		...
		panelWarPlane.add(buttonCreateWarPlane);
		...
		buttonCreateBomber.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				warPlane.SetPosition(posX, posY, panelWarPlane.getWidth(), panelWarPlane.getHeight());
				panelWarPlane.SetWarPlane(warPlane);
				panelWarPlane.repaint();
			}
		});
		...
		panelWarPlane.add(buttonCreateBomber);
